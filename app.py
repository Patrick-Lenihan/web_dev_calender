...
def calender():
    ...
    if hiddenForm.validate_on_submit():
        ...
        #output = returnDB()
        date_needed='False'
        return render_template('calender.html',hiddenForm=hiddenForm, output=output,outputAdd1=outputAdd1,outputAdd2=outputAdd2,outputAdd3=outputAdd3,outputAdd4=outputAdd4,outputAdd5=outputAdd5,outputAdd6=outputAdd6, date_needed=date_needed)
